...
export const controllerBodies: Record<GamepadType, BodyOptionConfig[]> = {
  ...
  nintendo: [{ name: 'Switch Pro', body: markRaw(SwitchProBodyComp), defaultViewBox: '0 0 1200 780' }],
}
    ...
    components: [
      {
        ...
        position: { top: '48%', left: '23%', width: '16%' },
      },
      {
        type: 'stick',
        logicalButton: 'RIGHT_STICK',
        svg: markRaw(RightStickSvgComp),
        position: { top: '65%', left: '57%', width: '16%' },
      },
      {
        type: 'button',
        logicalButton: 'LEFT_STICK_PRESS',
        name: 'L3',
        svg: markRaw(StickClickSvgComp),
        position: { top: '48%', left: '23%', width: '16%' },
      },
      {
        type: 'button',
        logicalButton: 'RIGHT_STICK_PRESS',
        name: 'R3',
        svg: markRaw(RightStickClickSvgComp),
        position: { top: '65%', left: '57%', width: '16%' },
      },
      {
        type: 'button',
        ...
        position: { top: '62%', left: '71.5%', width: '8%' },
      },
      {
        type: 'button',
        ...
        position: { top: '50%', left: '79%', width: '8%' },
      },
      {
        type: 'button',
        ...
        position: { top: '50%', left: '64%', width: '8%' },
      },
      {
        type: 'button',
        ...
        position: { top: '38%', left: '71.5%', width: '8%' },
      },
      {
        type: 'button',
        ...
        position: { top: '35%', left: '37%', width: '7%' },
      },
      {
        type: 'button',
        ...
        position: { top: '47%', left: '37%', width: '7%' },
      },
      {
        type: 'button',
        ...
        position: { top: '41%', left: '31%', width: '7%' },
      },
      {
        type: 'button',
        ...
        position: { top: '41%', left: '43%', width: '7%' },
      },
      {
        type: 'button',
        logicalButton: 'LEFT_SHOULDER_1',
        name: 'LB',
        svg: markRaw(XboxLBSvgComp),
        position: { top: '18%', left: '25%', width: '10%' },
      },
      {
        type: 'button',
        logicalButton: 'RIGHT_SHOULDER_1',
        name: 'RB',
        svg: markRaw(XboxRBSvgComp),
        position: { top: '18%', left: '65%', width: '10%' },
      },
      {
        type: 'button',
        logicalButton: 'LEFT_SHOULDER_2',
        name: 'LT',
        svg: markRaw(XboxLTSvgComp),
        position: { top: '7%', left: '25%', width: '10%' },
      },
      {
        type: 'button',
        logicalButton: 'RIGHT_SHOULDER_2',
        name: 'RT',
        svg: markRaw(XboxRTSvgComp),
        position: { top: '7%', left: '65%', width: '10%' },
      },
      {
        type: 'button',
        ...
        position: { top: '35%', left: '52%', width: '6%' },
      },
      {
        type: 'button',
        logicalButton: 'START',
        ...
        position: { top: '35%', left: '62%', width: '6%' },
      },
      {
        type: 'button',
        logicalButton: 'HOME',
        ...
        position: { top: '20%', left: '50%', width: '8%' },
      },
    ],
  },
  ps: {
    ...
    components: [
      {
        ...
        logicalButton: 'LEFT_STICK',
        svg: markRaw(StickSvgComp),
        position: { top: '58%', left: '24%', width: '15%' },
      },
      {
        type: 'stick',
        logicalButton: 'RIGHT_STICK',
        svg: markRaw(RightStickSvgComp),
        position: { top: '58%', left: '61%', width: '15%' },
      },
      {
        type: 'button',
        logicalButton: 'LEFT_STICK_PRESS',
      ...
      },
      {
        ...
        position: { top: '58%', left: '78%', width: '7%' },
      },
      {
        type: 'button',
        logicalButton: 'ACTION_RIGHT',
        ...
        position: { top: '46%', left: '84%', width: '7%' },
      },
      {
        type: 'button',
        logicalButton: 'ACTION_LEFT',
        ...
        position: { top: '46%', left: '72%', width: '7%' },
      },
      {
        type: 'button',
        logicalButton: 'ACTION_UP',
        ...
        position: { top: '34%', left: '78%', width: '7%' },
      },
      {
        type: 'button',
        ...
        position: { top: '20%', left: '35%', width: '30%', height: '25%' },
      },
      {
        type: 'button',
        logicalButton: 'LEFT_SHOULDER_1',
        name: 'L1',
        svg: markRaw(PsL1SvgComp),
        position: { top: '25%', left: '20%', width: '10%' },
      },
      {
        type: 'button',
        logicalButton: 'RIGHT_SHOULDER_1',
        name: 'R1',
        svg: markRaw(PsR1SvgComp),
        position: { top: '25%', left: '70%', width: '10%' },
      },
      {
        type: 'button',
        logicalButton: 'LEFT_SHOULDER_2',
        name: 'L2',
        svg: markRaw(XboxLTSvgComp),
        position: { top: '12%', left: '20%', width: '10%' },
      },
      {
        type: 'button',
        logicalButton: 'RIGHT_SHOULDER_2',
        name: 'R2',
        svg: markRaw(XboxRTSvgComp),
        position: { top: '12%', left: '70%', width: '10%' },
      },
      {
        type: 'button',
        logicalButton: 'SELECT',
        ...
        position: { top: '35%', left: '30%', width: '6%' },
      },
      {
        type: 'button',
        logicalButton: 'START',
        ...
        position: { top: '35%', left: '70%', width: '6%' },
      },
      {
        type: 'button',
        logicalButton: 'HOME',
        ...
        position: { top: '40%', left: '50%', width: '8%' },
      },
    ],
  },
  nintendo: {
    ...
    components: [
      {
        ...
        logicalButton: 'LEFT_STICK',
        svg: markRaw(StickSvgComp),
        position: { top: '40%', left: '23%', width: '16%' },
      },
      {
        type: 'stick',
        logicalButton: 'RIGHT_STICK',
        svg: markRaw(RightStickSvgComp),
        position: { top: '58%', left: '58%', width: '16%' },
      },
      {
        type: 'button',
        logicalButton: 'LEFT_STICK_PRESS',
      ...
      },
      {
        ...
        position: { top: '57%', left: '78%', width: '7%' },
      },
      {
        type: 'button',
        logicalButton: 'ACTION_RIGHT',
        ...
        position: { top: '45%', left: '85%', width: '7%' },
      },
      {
        type: 'button',
        logicalButton: 'ACTION_LEFT',
        ...
        position: { top: '45%', left: '71%', width: '7%' },
      },
      {
        type: 'button',
        logicalButton: 'ACTION_UP',
      ...
      },
      {
        ...
        position: { top: '48%', left: '42%', width: '5%' },
      },
      {
        type: 'button',
        logicalButton: 'LEFT_SHOULDER_1',
        ...
        position: { top: '20%', left: '25%', width: '10%' },
      },
      {
        type: 'button',
        logicalButton: 'RIGHT_SHOULDER_1',
        ...
        position: { top: '20%', left: '65%', width: '10%' },
      },
      {
        type: 'button',
        logicalButton: 'LEFT_SHOULDER_2',
        ...
        position: { top: '10%', left: '25%', width: '10%' },
      },
      {
        type: 'button',
        logicalButton: 'RIGHT_SHOULDER_2',
        ...
        position: { top: '10%', left: '65%', width: '10%' },
      },
      {
        type: 'button',
        logicalButton: 'SELECT',
        ...
        position: { top: '35%', left: '35%', width: '5%' },
      },
      {
        type: 'button',
        logicalButton: 'START',
        ...
        position: { top: '35%', left: '65%', width: '5%' },
      },
    ],
  },
}
