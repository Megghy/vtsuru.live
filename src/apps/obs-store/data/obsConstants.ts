...
export interface OBSComponentDefinition {
  ...
  component: Component // Vue 组件本身 (异步或同步)
...
export const OBSComponentMap: Record<string, OBSComponentDefinition> = {
  ...
  //   component: defineAsyncComponent(() => import('@/apps/obs-store/components/ExampleOBSComponent.vue')),
  ...
  Example: {
    ...
    component: defineAsyncComponent(async () => import('@/apps/obs-store/components/ExampleOBSComponent.vue')),
    version: '1.0.0',
  },
  Controller: {
    id: 'Controller',
    ...
    component: defineAsyncComponent(async () => import('@/apps/obs-store/components/gamepads/GamepadViewer.vue')),
    version: '1.0.0',
  },
}
