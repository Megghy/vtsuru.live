...
export const USER_FEATURE_DEFINITIONS: readonly UserFeatureDefinition[] = [
  { key: 'songList', label: '歌单 / 点歌', routeName: 'user-songList', icon: MusicalNotesOutline, functionType: FunctionTypes.SongList },
  { key: 'questionBox', label: '提问箱', routeName: 'user-questionBox', icon: ChatboxOutline, functionType: FunctionTypes.QuestionBox },
  { key: 'checkInRanking', label: '签到排行', routeName: 'user-checkin', icon: CheckmarkCircle24Filled, functionType: FunctionTypes.CheckInRanking },
  { key: 'pointGoods', label: '积分兑换', routeName: 'user-goods', icon: BookCoins20Filled, functionType: FunctionTypes.Point },
  { key: 'videoCollect', label: '视频征集', routeName: 'user-video-collect', icon: VideoAdd20Filled, functionType: FunctionTypes.VideoCollect },
  { key: 'forum', label: '讨论区', routeName: 'user-forum', icon: ChatbubblesOutline, functionType: null },
  { key: 'schedule', label: '直播日程', routeName: 'user-schedule', icon: CalendarClock24Filled, functionType: FunctionTypes.Schedule },
]
