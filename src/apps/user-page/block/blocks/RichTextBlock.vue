...
.rich-text :deep(img) { display: block; max-width: 100%; height: auto; margin: 1.5em auto; border: 1px solid var(--vtsuru-block-border); border-radius: var(--vtsuru-page-radius); }
.rich-text :deep(blockquote) { margin: 1.5em 0; padding: 0.5em 1.25em; border-left: 4px solid var(--vtsuru-block-border); border-radius: 4px; color: var(--vtsuru-block-fg-muted); background: var(--vtsuru-block-bg-muted); }
...
.rich-text :deep(:not(pre) > code) { padding: 0.14em 0.4em; border: 1px solid var(--vtsuru-block-border); border-radius: 6px; background: var(--vtsuru-block-bg-muted); font-size: 0.92em; white-space: break-spaces; }
.rich-text :deep(pre) { margin: 1.5em 0; padding: 12px 16px; overflow: auto; border: 1px solid var(--vtsuru-block-border); border-radius: var(--vtsuru-page-radius); background: var(--vtsuru-block-bg-muted); font-size: 13px; }
.rich-text :deep(pre > code) { padding: 0; border: 0; background: transparent; font-size: inherit; line-height: 1.6; }
.rich-text :deep(hr) { margin: 2em 0; border: 0; border-top: 1px solid var(--vtsuru-block-border); }
