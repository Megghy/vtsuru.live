    ...
    >
        ...
        >
          ...
          >
            ...
            <NRadioGroup
              ...
              @update:value="onChange"
            >
              <NRadioButton :value="QueueGiftFilterType.And"> 需同时满足名称和价值 </NRadioButton>
              <NRadioButton :value="QueueGiftFilterType.Or"> 满足名称或价值之一 </NRadioButton>
            </NRadioGroup>
            <NCheckbox
      ...
      >
        ...
        >
          ...
          <NCheckbox v-model:checked="isWarnMessageAutoClose"> 自动关闭"加入队列失败"的通知消息 (默认3秒) </NCheckbox>
        </NFlex>
      </NCard>
    </NFlex>
  </NSpin>
