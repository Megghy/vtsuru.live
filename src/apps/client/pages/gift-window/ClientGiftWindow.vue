...
<template>
  ...
  <div
    v-else
    class="gw"
    :class="{ compact: setting.compactMode }"
  >
    <div class="gw-header">
...
.gw-item--sc {
  ...
  background: linear-gradient(135deg, rgba(245, 158, 11, 0.12) 0%, var(--gw-bg-color) 50%);
}
.gw-item--guard {
  border-left-color: #a78bfa;
  background: linear-gradient(135deg, rgba(167, 139, 250, 0.12) 0%, var(--gw-bg-color) 50%);
}
