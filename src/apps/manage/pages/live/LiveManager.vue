  ...
  <template v-else>
    <NCard style="margin-top: 24px; margin-bottom: 24px; max-width: 1200px; left: 50%; transform: translateX(-50%);" size="small">
      <NSpace justify="space-between" align="center" wrap item-style="flex-grow: 1">
        ...
        <NSpace align="center" wrap>
          ...
          <NSelect
            v-model:value="statusFilter" :options="[
        ...
        <NSpace align="center" wrap>
          <NSpace align="center" :size="12">
            ...
            <NSelect
              v-model:value="sortKey" size="small" :options="[
            ...
            />
            <NSelect
              v-model:value="sortOrder" size="small" :options="[
                { label: '降序', value: 'desc' },
                { label: '升序', value: 'asc' },
              ]" style="width: 90px"
            />
          ...
          <NSpace align="center">
            ...
            <NInputNumber
              v-if="enableAutoRefresh" v-model:value="refreshSeconds" size="small" style="width: 80px"
    ...
    <template v-else>
      <NEmpty v-if="!filteredAndSortedLives.length" description="没有找到符合条件的直播记录">
        <template #extra>
          <NButton type="primary" @click="getAll">
            重新加载
          </NButton>
        </template>
      </NEmpty>
      ...
      <div v-else class="list-container">
        <NList hoverable clickable class="live-list">
          <NListItem v-for="live in pagedLives" :key="live.liveId" class="live-list-item" @click="OnClickCover(live)">
        ...
        <NSpace justify="center" align="center" style="margin-top: 24px; margin-bottom: 48px;">
          <NPagination
            v-model:page="page" v-model:page-size="pageSize" show-quick-jumper show-size-picker
