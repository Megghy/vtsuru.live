  ...
  <NForm label-placement="top" size="small">
    <PropsGrid>
      ...
      <NFormItem class="span-full" label="按钮项">
        <RepeaterEditor :items="editor.ensureItems(props.block)" :create-item="() => ({ label: '', url: 'https://' })" add-text="添加按钮">
          ...
          <template #default="{ item }">
            <PropsGrid>
              ...
              <NFormItem class="span-full" label="目标">
                <NSelect v-if="item.page" v-model:value="item.page" :options="internalPageOptions" />
                <NInput v-else-if="!item.back" v-model:value="item.url" placeholder="https://..." />
