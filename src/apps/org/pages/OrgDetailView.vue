...
import OrgAuditTabPane from '@/apps/org/components/tabs/OrgAuditTabPane.vue'
import OrgLivesTab from '@/apps/org/components/tabs/OrgLivesTab.vue'
import OrgMembersTab from '@/apps/org/components/tabs/OrgMembersTab.vue'
import OrgOrdersTab from '@/apps/org/components/tabs/OrgOrdersTab.vue'
import OrgPointsTab from '@/apps/org/components/tabs/OrgPointsTab.vue'
import OrgStreamersTab from '@/apps/org/components/tabs/OrgStreamersTab.vue'
    ...
    <template v-else>
      ...
      <NTabs type="line" animated style="margin-top: 12px;">
        <NTabPane name="analyze" tab="数据分析">
          <OrgAnalyzeTab
            v-model:summary-range="summaryRange"
        ...
        <NTabPane name="streamers" tab="主播管理">
          <OrgStreamersTab
            v-model:streamer-invite-target-user-id="streamerInviteTargetUserId"
            v-model:streamer-invite-expire-days="streamerInviteExpireDays"
            v-model:streamer-search="streamerSearch"
            v-model:include-all-streamers="includeAllStreamers"
        ...
        <NTabPane name="members" tab="成员管理">
          <OrgMembersTab
            v-model:member-invite-role="memberInviteRole"
            v-model:member-invite-target-user-id="memberInviteTargetUserId"
            v-model:member-invite-expire-days="memberInviteExpireDays"
