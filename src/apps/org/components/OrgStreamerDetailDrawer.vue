  ...
  >
    <NDrawerContent>
      <template #header>
        ...
        >
          <OrgUserAvatar
            :face-url="d.detail.value?.streamer.faceUrl"
            :size="40"
          />
          <NFlex
            vertical
          ...
          <NTag
            ...
            :bordered="false"
            size="small"
            :type="streamerStatusTagType(d.detail.value.status)"
        ...
        <template v-else>
          ...
          >
            <NGridItem>
              ...
              >
                <NStatistic
                  label="总收入"
                  :value="d.detail.value.summary.totalIncomeWithGuard"
                  :precision="2"
                >
            ...
            <NGridItem>
              ...
              >
                <NStatistic
                  label="直播时长"
                  :value="d.detail.value.summary.totalLiveMinutes"
                >
            ...
            <NGridItem>
              ...
              >
                <NStatistic
                  label="互动"
                  :value="d.detail.value.summary.totalInteractionCount"
                />
              </NCard>
            </NGridItem>
            <NGridItem>
              ...
              >
                <NStatistic
                  label="弹幕"
                  :value="d.detail.value.summary.totalDanmakuCount"
                />
              </NCard>
            </NGridItem>
          </NGrid>
          ...
          >
            ...
            >
              ...
              <NFormItem label="备注">
                <NInput
                  v-model:value="d.editNote.value"
                  type="textarea"
                  :autosize="{ minRows: 2, maxRows: 4 }"
                  placeholder="仅组织管理员可见"
                />
              </NFormItem>
              <NFormItem>
                <NButton
                  type="primary"
                  :loading="d.saving.value"
                  @click="d.save(() => emit('saved'))"
                >
                  保存
                </NButton>
              </NFormItem>
          ...
          >
            <NEmpty
              v-if="d.lives.value.length === 0"
              description="暂无直播记录"
            />
            <NList v-else>
              <NListItem
                v-for="live in d.lives.value"
                :key="live.liveId"
              >
                <NFlex
                  :wrap="false"
