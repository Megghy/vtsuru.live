...
import ClassicRequestOBS from '@/apps/obs/components/request/ClassicRequestOBS.vue'
import FreshRequestOBS from '@/apps/obs/components/request/FreshRequestOBS.vue'
import MinimalRequestOBS from '@/apps/obs/components/request/MinimalRequestOBS.vue'
