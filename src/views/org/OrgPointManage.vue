          ...
          <NListItem v-for="goods in pointGoods.slice(0, 5)" :key="goods.id">
            <div style="display: flex; justify-content: space-between; align-items: center;">
              <div>
                ...
                <div style="font-size: 12px; opacity: 0.7;">{{ goods.description }}</div>
              </div>
              <div>
                <NTag type="info" size="small">{{ goods.price }} 积分</NTag>
                <NTag v-if="goods.stock > 0" type="success" size="small">库存: {{ goods.stock }}</NTag>
                <NTag v-else type="error" size="small">缺货</NTag>
              </div>
            </div>
          </NListItem>
        </NList>
          ...
          <NListItem v-for="log in auditLogs" :key="log.id">
            <div style="display: flex; justify-content: space-between; align-items: center;">
              <div>
                ...
                <div style="font-size: 12px; opacity: 0.7;">{{ log.detail }}</div>
