...
export const NOTIFICATION_API_URL = `${BASE_API_URL}notification/`
...
export const SUPPORT_TICKET_API_URL = `${BASE_API_URL}support-tickets/`
...
export const USER_PAGES_API_URL = `${BASE_API_URL}user-pages/`
