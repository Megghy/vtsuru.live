...
- 文件放置：
  - 全局页面：`src/views/contrib/pages/<pageId>.vue`
  - 主播专属页面：`src/views/contrib/pages/<streamerId>/<pageId>.vue`
...
- [TODO] Contrib Page 加载清单（`import.meta.glob('src/views/contrib/pages/**')`）
