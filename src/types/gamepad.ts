...
export const LogicalButtonsList = [
  'ACTION_DOWN', 'ACTION_RIGHT', 'ACTION_LEFT', 'ACTION_UP',
  'LEFT_SHOULDER_1', 'RIGHT_SHOULDER_1', 'LEFT_SHOULDER_2', 'RIGHT_SHOULDER_2',
  'SELECT', 'START', 'LEFT_STICK_PRESS', 'RIGHT_STICK_PRESS',
  'DPAD_UP', 'DPAD_DOWN', 'DPAD_LEFT', 'DPAD_RIGHT',
  'HOME', 'PS_TOUCHPAD', 'NINTENDO_CAPTURE',
] as const;
