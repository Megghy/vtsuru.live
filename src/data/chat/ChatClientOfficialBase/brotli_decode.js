...
const makeBrotliDecode = () => {
  ...
  function unpackCommandLookupTable(cmdLookup) {
    ...
    for (let /** @type{number} */ cmdCode = 0; cmdCode < 704; ++cmdCode) {
      ...
      const /** @type{number} */ distanceContext =
  ...
  function doUseDictionary(s, fence) {
    ...
    if (address < 0) {
      ...
      const /** @type{number} */ len = transformDictionaryWord(
          s.ringBuffer,
          s.pos,
          dictionaryData,
          offset,
        ...
        case 7:
          if (s.trivialLiteralContext != 0) {
            ...
            while (s.j < s.insertLength) {
              ...
              const /** @type{number} */ literalContext =
  ...
  function decode(bytes, options) {
    ...
    if (options) {
      const customDictionary = /** @type {?Int8Array} */ (options['customDictionary'])
